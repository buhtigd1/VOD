...
STATIC_LOGO_URL = "https://raw.githubusercontent.com/buhtigd1/VOD/main/movie.jpg"
MAX_WORKERS = 50
CHECK_TIMEOUT = 5
...
try:
    with open("vod.m3u8", "w", encoding="utf-8") as file:
        file.write(m3u8_content)
    print(f"\n\nSuccess! Wrote {len(valid_channels)} valid streams to 'vod.m3u8'.")
